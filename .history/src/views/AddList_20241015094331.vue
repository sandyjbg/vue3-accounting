...
function paymentConfirm() {
  const firstPayment = inputValues.value[selectedOptions.value[0]]
  const secondPayment = inputValues.value[selectedOptions.value[1]]
  if ( firstPayment === '' || firstPayment === '0' || secondPayment === '' || secondPayment === '0' ){
    message.warning('請正確輸入分別金額')
  }
