          ...
          <div class="dayDetail" v-for="(items, date) in sortListbyTime">
            ...
            <div class="dayList">
              ...
              <div class="biggerEachList">
                ...
                <div @click="toggleMoreFunction(index)" v-if="element.moreFunction" class="moreBtn"></div>
