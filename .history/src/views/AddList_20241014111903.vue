        ...
        <div class="mask" v-if="mergePaymentOn">
          <div class="background">
            <div class="eachPayment">
              ...
              <n-input v-model:value="inputValues[selectedOptions[0]]" type="text" :placeholder="`${selectedOptions[0]}支出金額`" />
            </div>
            <div class="eachPayment">
              <p>{{ selectedOptions[1] + '：' }}</p>
              <n-input v-model:value="inputValues[selectedOptions[1]]" type="text" :placeholder="`${selectedOptions[1]}支出金額`" />
            </div>
            <div class="result">
