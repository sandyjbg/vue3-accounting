...
nextTick(() => {
  categoryIcon.value = ref(FreeBreakfastRound)
})
...
const categories = ref<Category[]>([
  ...
  {
    id: 7,
    icon: ref(DirectionsBusFilledFilled),
    color: '#76b1bd',
    name: '交通',
    type: '支出'
  },
  ...
  {
    id: 10,
    icon: ref(LocalGroceryStoreTwotone),
    color: '#23c9b5',
    name: '日用品',
    type: '支出'
  },
  ...
  {
    id: 12,
    icon: ref(AccountBalanceWalletFilled),
    color: '#8d5554',
    name: '薪水',
    type: '收入'
  },
  ...
  {
    id: 16,
    icon: ref(DeliveryDiningTwotone),
    color: '#b0be61',
    name: '贈予',
    type: '收入'
  },
