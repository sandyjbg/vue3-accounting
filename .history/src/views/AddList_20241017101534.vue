        ...
        <div class="mask" v-if="mergePaymentOn">
          <div class="background">
            <div class="eachPayment">
              ...
              <n-input :ref=selectedOptions[0] v-model:value="inputValues[selectedOptions[0]]" type="text" @focus="setFocusInput(selectedOptions[0])" />
            </div>
            <div class="eachPayment">
              <p>{{ selectedOptions[1] + '：' }}</p>
              <n-input :ref=selectedOptions[1] v-model:value="inputValues[selectedOptions[1]]" type="text" @focus="setFocusInput(selectedOptions[1])" />
            </div>
            <div class="result">
...
function commit() {
  ...
  console.log(dataToSubmit,moneyMoreOrLest.value,dataToSubmit.value)
