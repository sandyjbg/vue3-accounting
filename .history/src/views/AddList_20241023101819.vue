<template>
  <n-message-provider>
    ...
    <PaymentChoose v-if="showPaymentChoose" :paymentList="paymentOption" :paymentConfirm="paymentConfirm" :paymentClose="closePaymentChooseModal"
      @commitMergePayment="AddMergePayment" />
...
const dataToSubmit = {
  ...
  console.log(dataToSubmit.selectedOptions.value)
