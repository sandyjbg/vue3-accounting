<template>
  <n-message-provider>
        ...
        <div class="amount">
          ...
          <div class="account">
            ...
            <div class="paymentList">
              ...
              <p @click="showAddressInput = true" class="selected"><n-icon :component="LocationOnRound"/>地址</p>
    ...
    <AddressInput v-if="showAddressInput" :closeAddressInput="closeAddressInput"/>
