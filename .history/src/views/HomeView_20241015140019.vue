          ...
          <div class="dayList">
            <div class="biggerEachList" v-for="(list, index) in [...items.income, ...items.expense]">
              ...
              <div v-else class="list">
                <n-icon class="back" :component="ArrowRightRound" />
...
import { DensityMediumTwotone, ArrowLeftRound, ArrowRightRound, ContentCopyFilled, DeleteFilled, EditFilled } from '@vicons/material'
