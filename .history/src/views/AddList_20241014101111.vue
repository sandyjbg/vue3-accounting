  ...
  <div class="box">
    <div class="background">
      ...
      <div class="mask" v-if="mergePaymentOn">
        <div class="background">
          <div class="eachPayment" v-for="(option, index) in selectedOptions" :key="index">
            <p>{{ option + '：' }}</p>
            <n-input v-model:value="inputValues" type="text" :placeholder="`${option}支出金額`" />
          </div>
          <div class="result">
      ...
      .background {
        ...
        .eachPayment {
          ...
          :deep(.n-input) {
            ...
            --n-border: 1px solid rgb(124, 124, 124) !important;
            --n-border-disabled: 1px solid rgb(124, 124, 124) !important;
            --n-border-hover: 1px solid rgb(124, 124, 124) !important;
            --n-border-focus: 1px solid rgb(124, 124, 124) !important;
            --n-box-shadow-focus: 0 0 0 2px rgb(124, 124, 124) !important;
