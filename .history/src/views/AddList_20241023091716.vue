<template>
  <n-message-provider>
    ...
    <PaymentChoose v-if="showPaymentChoose" :paymentList="paymentOption" :paymentClose="closePaymentChooseModal" :paymentConfirm="closePaymentChooseModal" @commitMergePayment="AddMergePayment"/>
