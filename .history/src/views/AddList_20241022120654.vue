        ...
        <div class="amount">
          ...
          <div class="account">
            ...
            <div class="paymentList">
              <n-dropdown trigger="click" placement="bottom-start" :options="paymentOption" @select="paymentHandleSelect(value)">
...
import AddressInput from './../components/addlist/Address.vue'
...
const paymentOption = ref([{ label: '現金', value:'現金' }, { label: '信用卡' }, { label: '金融卡' }, { label: '悠遊卡' }, {label: '混合支付(兩種支付方式)' }])
...
function paymentHandleSelect(value){
  console.log(value)
}
