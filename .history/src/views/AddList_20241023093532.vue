        ...
        <div class="mask" v-if="mergePaymentOn">
          <div class="background">
            <div class="eachPayment">
              ...
              :placeholder="`請輸入${selectedOptions[0]}支出金額`" @focus="setFocusInput(selectedOptions[0])" />
            </div>
            <div class="eachPayment">
              <p>{{ selectedOptions[1] + '：' }}</p>
              <n-input :ref=selectedOptions[1] v-model:value="inputValues[selectedOptions[1]]" type="text"
              :placeholder="`請輸入${selectedOptions[1]}支出金額`" @focus="setFocusInput(selectedOptions[1])" />
            </div>
            <div class="result">
