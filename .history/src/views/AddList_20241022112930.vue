        ...
        <div class="amount">
          ...
          <div class="account">
            ...
            <div class="paymentList">
              <n-dropdown trigger="click" placement="bottom-start" :options="paymentOption" @select="handleSelect">
                <n-button><n-icon :component="MoneyOutlined" />{{ paymentOption[0].label }}</n-button>
              </n-dropdown>
              <n-dropdown trigger="click" placement="bottom-start">
                <template #addressInput>
                  <div style="padding: 10px;">
                    <n-input v-model="addressInput" placeholder="請輸入地址" />
                  </div>
                </template>
                <n-button><n-icon :component="LocationOnRound" />地址</n-button>
              </n-dropdown>
...
const paymentOption = ref([{ label: '現金' }, { label: '信用卡' }, { label: '金融卡' }, { label: '悠遊卡' }])
