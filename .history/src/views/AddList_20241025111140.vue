<template>
  <n-message-provider>
    ...
    <PaymentChoose v-if="showPaymentChoose" :paymentList="paymentOption" :paymentConfirm="paymentConfirm"
      ...
      <MergePayment v-if="showMergePayment" :mergePayment="selectedOptions" :closeMerge="closeMergePaymentModal" :amountModel="showMergePaymentAmount"/>
      <MergePaymentAmount v-if="showMergePaymentAmount" :closeMergePaymentAmountModel="closeMergePaymentAmountModel"/>
...
function closeMergePaymentAmount(){
