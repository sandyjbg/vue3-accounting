              ...
              <n-collapse-item :title="list.category" name="1">
                <div class="smallList" v-for="(item, idx) in listFiltered(list.category)"
                  ...
                  <div class="first">
                    ...
                    <div class="date" :style="{ color: item.color }">{{ item.date }}</div>
                    <div class="word" :style="{ color: item.color }">{{ item.description }}</div>
                  </div>
                  <div class="amount" :style="{ color: item.color }">{{ item.amount }}</div>
                </div>
              </n-collapse-item>
            </n-collapse>
          </div>
...
onMounted(() => {
  ...
  // 時間切換
  function formattedDate(isoDateString: string) {
