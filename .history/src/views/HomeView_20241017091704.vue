      ...
      <div class="background">
        ...
        <div class="content">
          <div class="dayDetail" v-for="(items, date) in sortListbyTime">
            ...
            <draggable class="dayList" v-model="items.income" group="items" @end="onDragEnd">
              <template #item="{ element, index }">
              <div class="biggerEachList" v-for="(list, index) in items.income">
                <div
            ...
            <draggable class="dayList" v-model="items.expense" group="items" @end="onDragEnd">
              <template #item="{ element, index }">
              <div class="biggerEachList" v-for="(list, index) in items.expense">
                <div
                  :class="['eachList', { more: !moreFunction, input: list.type === '收入', output: list.type !== '收入' }]">
                  <div class="project">
                    <n-checkbox v-if="list.merging" :value="index" />
...
const onDragEnd = () => {
  console.log('Drag ended, updated items:', lists.value);
  // calculateMonthlyAmount(); // 拖曳後更新月收入與支出
};
