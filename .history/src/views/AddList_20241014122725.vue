...
function num(number: string) {
  if ((focusedWhichOne.value && inputValues.value[focusedWhichOne.value] === '0')
     { inputValues.value[focusedWhichOne.value] = number } else { inputValues.value[focusedWhichOne.value] += number }
}) else {
...
screenValue.value = inputValues.value[focusedWhichOne.value]
