      ...
      <div class="amount">
        ...
        <div class="moneyInfo">
          <div class="realCategory" :style="{ backgroundColor: categoryColor }">
            <n-icon :component="categoryIcon.value" />
            <p>{{ categoryName }}</p>
          </div>
...
import { ref, h, onMounted, onBeforeUnmount, shallowRef, computed, watch, markRaw, nextTick, type Component } from 'vue'
...
const categoryIcon = shallowRef(FreeBreakfastRound)
...
nextTick(() => {
  categoryIcon.value = markRaw(FreeBreakfastRound)
})
