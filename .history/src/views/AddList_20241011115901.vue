      ...
      <div class="amount">
        ...
        <div class="account">
          ...
          <div class="paymentList">
            <p :class="{ selected: selectedOptions.includes(option) }" @click="selectedpayment(option, idx)"
            v-for="(option,idx) in paymentOption" :key="idx">{{ option }}</p>
          </div>
        </div>
...
function selectedpayment(option:string, idx:number){
