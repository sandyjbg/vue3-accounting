    ...
    <div class="background">
      ...
      <div class="content">
        <div class="dayDetail" v-for="(items, date) in sortListbyTime" :key="date">
          ...
          <div class="dayList">
            <div class="biggerEachList" v-for="list in [...items.income, ...items.expense]">
              <div :class="['eachList', { more: !moreFunction, input: list.type === '收入', output: list.type !== '收入' }]">
                <div class="project">
                  <n-icon :component="list.icon" :style="{ backgroundColor: list.color }" />
                  <p>{{ list.category }}</p>
                  <p v-if="list.description">-- {{ list.description }}</p>
                </div>
                <div class="number" v-if="moreFunction">
                  <div class="payment">
              ...
              <div v-if="moreFunction" class="moreBtn"></div>
...
import { DensityMediumTwotone, PlusOutlined, ArrowLeftRound, ArrowRightRound, ContentCopyFilled, DeleteFilled, EditFilled } from '@vicons/material'
