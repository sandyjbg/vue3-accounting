  ...
  <div class="mask">
    <div class="paymentList">
      <n-checkbox-group v-model:value="cities">
        <p>最多只能選擇兩種支付方式</p>
        <n-checkbox v-for="payment in paymentEndLists" :value="payment.key" :label="payment.label" :disable="payment.disbale"/>
      </n-checkbox-group>
    </div>
  </div>
</template>
...
const paymentEndLists = paymentLists.map((item:any) => ({
  ...item,
  disabled: false
}))
