...
import { ref, h, onMounted, onBeforeUnmount, shallowRef, computed, watch, markRaw, type Component } from 'vue'
...
const categoryIcon = shallowRef(markRaw(FreeBreakfastRound))
...
const existingCategory = ref({ id: -1, name: '', color: '', icon: markRaw(FreeBreakfastRound) })
...
const categories = ref<Category[]>([
  {
    id: 1,
    icon: markRaw(FreeBreakfastRound),
    color: '#dc6980',
    name: '早餐',
    type: '支出'
  },
  ...
  {
    id: 3,
    icon: markRaw(DinnerDiningRound),
    color: '#2ea662',
    name: '晚餐',
    type: '支出'
  },
  ...
  {
    id: 7,
    icon: markRaw(DirectionsBusFilledFilled),
    color: '#76b1bd',
    name: '交通',
    type: '支出'
  },
  {
    id: 8,
    icon: markRaw(ShoppingCartFilled),
    color: '#da8f86',
    name: '購物',
    type: '支出'
  },
  {
    id: 9,
    icon: markRaw(VideogameAssetFilled),
    color: '#d3b97c',
    name: '娛樂',
    type: '支出'
  },
  {
    id: 10,
    icon: markRaw(LocalGroceryStoreTwotone),
    color: '#23c9b5',
    name: '日用品',
    type: '支出'
  },
  ...
  {
    id: 12,
    icon: markRaw(AccountBalanceWalletFilled),
    color: '#8d5554',
    name: '薪水',
    type: '收入'
  },
  ...
  {
    id: 16,
    icon: markRaw(DeliveryDiningTwotone),
    color: '#b0be61',
    name: '贈予',
    type: '收入'
  },
  {
    id: 17,
    icon: markRaw(AccountBalanceRound),
    color: '#76c8e8',
    name: '投資',
    type: '收入'
  },
...
function vmodelicon(name: string, icon: Component, color: string) {
  ...
  categoryIcon.value = shallowRef(markRaw(icon))
...
function commit() {
  ...
  console.log(moneyMoreOrLest.value, dataToSubmit.type, dataToSubmit)
...
function AddCategoryList(newCategory: { name: string, color: string, icon: Component }) {
  ...
  categories.value.splice(categoryPushIdx, 0, newCategory)
    ...
    .datePickder {
      :deep(.n-date-picker) {
        ...
        .n-input--stateful {
          ...
          --n-padding-left: 190px !important;
